...
<html> 
    ...
    <body>
        ...
        <form id="formulario1" name="formulario1" method="GET" action="../controlador/E6_controlador.php">
        <label>Nombre:</label>
        ...
        <div class="deportes-container">
            ...
            <div class="deporte-option">
                <input type="checkbox" id="futbol" name="deportes[]" value="futbol" <?php echo (isset($deportes) && in_array('futbol', $deportes)) ? 'checked' : ''; ?>>
                <label for="futbol">Fútbol</label>
            </div>
            <div class="deporte-option">
                <input type="checkbox" id="basket" name="deportes[]" value="basket" <?php echo (isset($deportes) && in_array('basket', $deportes)) ? 'checked' : ''; ?>>
                <label for="basket">Basket</label>
            </div>
            <div class="deporte-option">
                <input type="checkbox" id="tennis" name="deportes[]" value="tennis" <?php echo (isset($deportes) && in_array('tennis', $deportes)) ? 'checked' : ''; ?>>
                <label for="tennis">Tennis</label>
            </div>
            <div class="deporte-option">
                <input type="checkbox" id="voley" name="deportes[]" value="voley" <?php echo (isset($deportes) && in_array('voley', $deportes)) ? 'checked' : ''; ?>>
                <label for="voley">Voley</label>
            </div>
        </div>
        <?php if (isset($errores['deportes'])): ?>
            <span class="error"><?php echo $errores['deportes']; ?></span>
        <?php endif; ?>
        <br>
        <div>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                formulario.addEventListener('submit', function(event) {
                    ...
                    // Validar deportes (al menos uno seleccionado)
                    const deportesSeleccionados = document.querySelectorAll('input[name="deportes[]"]:checked');
                    if (deportesSeleccionados.length === 0) {
                        errores['deportes'] = 'Debe seleccionar al menos un deporte.';
                        hayErrores = true;
                    }
                ...
                function mostrarErrores(errores) {
                    ...
                    for (const campo in errores) {
                        if (errores[campo]) {
                            ...
                            } else if (campo === 'deportes') {
                                elemento = document.querySelector('.deportes-container');
                            } else {
