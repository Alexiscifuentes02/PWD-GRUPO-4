...
?>
    <div class="container mt-4">
        ...
        <form id="formPelicula" action="Action3.php" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
            <div class="row mb-3">
                <div class="col">
    ...
    <script src= "../../Controlador/TP3/ControladorCliente3.js"></script>
