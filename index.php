...
<head>
  ...
  <!-- Bootstrap referenciado para que no de problemas-->
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>

<?php include_once("Vista/Estructura/Encabezado.php"); ?>

<main class="container my-5 text-center">
    <!-- TRABAJO PRÁCTICO 1 -->
    
    <section class="mb-5">
        <h2 class="mb-4 text-center">Trabajo Práctico 1</h2>
    ...
    <!-- TRABAJO PRÁCTICO 2 -->
    <section class="mb-5">
        <h2 class="mb-4 text-center">Trabajo Práctico 2</h2>
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="card shadow-lg border-0 rounded-3">
                    <ul class="list-group list-group-flush">
    ...
    <!-- TRABAJO PRÁCTICO 3 -->
    <section class="mb-5">
        <h2 class="mb-4 text-center">Trabajo Práctico 3</h2>
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="card shadow-lg border-0 rounded-3">
                    <ul class="list-group list-group-flush">
